...
$sql = "SELECT * FROM productos WHERE id_categoria = 2 $order_sql";
...
<div class="contenedor catalogo-contenedor">
    ...
    <div class="filtros">
        <a href="shoes.php" class="filtro">All</a>
        <a href="shoes.php?orden=precio_asc" class="filtro">Price ↑</a>
        <a href="shoes.php?orden=precio_desc" class="filtro">Price ↓</a>
        <a href="shoes.php?orden=marca_asc" class="filtro">A → Z</a>
        <a href="shoes.php?orden=marca_desc" class="filtro">Z → A</a>
    </div>
